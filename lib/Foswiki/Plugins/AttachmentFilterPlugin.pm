...
$SHORTDESCRIPTION = 'This plugin filters attachment by their content type and allows to block specific attachments';
$NO_PREFS_IN_TOPIC = 1;
...
sub beforeAttachmentSaveHandler {
    ...
    my $allowedTypes = $Foswiki::cfg{Plugins}{AttachmentFilterPlugin}{AllowedFiltypes};
